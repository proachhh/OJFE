export const m = {
  ...
  Learning_Path: '路径',
  Immersive_Practice: '刷题',
  Immersion_Loading: '正在为你挑选题目...',
  No_Recommendations_Immersion: '暂无推荐题目，请先做一些题目吧',
  Target_Topic: '目标知识点',
  ...
  Spark_AI_Assistant: '星火大模型',
  Spark_AI: '星火',
  Hello_I_Am_Spark_AI: '你好！我是星火大模型',
  Spark_AI_Description: '我可以帮你解答编程问题、算法思路、代码调试等各种技术问题',
  Me: '我',
  AI_Thinking: '正在思考...',
  Enter_Your_Question_Start: '输入你的问题开始对话...',
  Enter_Your_Question: '输入你的问题...',
  Send: '发送',
  Run_Code: '运行代码',
  Clear: '清空',
  Run_Result: '运行结果',
  Write_Code_Here: '// 在这里编写代码\n',
  // AIChatFullscreen.vue
  Clear_Chat: '清空对话',
  // CodeEditorFullscreen.vue
  Free_Code_Editor_Desc: '自由代码编辑器 - 无需绑定题目，直接运行代码',
  Copy: '复制',
  Run_Time: '运行时间',
  Memory_Usage: '内存使用',
  Program_Output: '程序输出',
  ...
  Memory: '内存',
  // LearningReport.vue
  No_Knowledge_Data: '暂无知识点数据',
  Weakness_Advice_No_Submission: '知识点您已提交 {total} 次，但尚未通过任何一题，建议加强练习。',
  // LearningPath.vue
  Learning_Path_Subtitle: '选择起点和目标，生成你的专属学习路径',
  Search_Topics: '查找知识点',
  // Home.vue
  Home_Hero_Title: '探索 · 知识星海',
  Home_Hero_Subtitle: 'From Zero to Hero，构建你的专属学习路径',
  ...
  Feature_Recommendation_Desc: '基于你的学习数据，智能推荐适合你的题目，高效提升',
  Feature_Evaluation: '实时评测系统',
  Feature_Evaluation_Desc: '支持多种编程语言，秒级评测结果，详细的错误反馈帮助你快速定位问题',
  Feature_AI_Gen: '智能生成题目',
  Feature_AI_Gen_Desc: 'Agent智能生成个性化练习题，针对薄弱知识点精准强化',
  Feature_AI_Agent: '多智能体Agent助手',
  Feature_AI_Agent_Desc: '6大智能体协同工作：画像分析、资源生成、学习路径规划、题目推荐、解题提示、错误诊断',
  Smart_Personalized_Advice: '智能个性化学习建议',
  Smart_Gen_Advice: '智能生成学习建议',
  Smart_Topic_Summary: '智能知识点总结',
  Smart_Gen_Summary: '智能生成总结',
  Smart_Profile_Invite: '让智能助手深入了解你的学习情况，为你量身定制学习路径和题目推荐。',
  Smart_Profile_CTA: '智能助手将为你生成专属学习画像',
  Smart_Profile_Onboarding_Desc: '为了更好地为你推荐学习路径和题目，请先回答几个简单的问题，帮助智能助手了解你的学习情况。',
  Smart_Chat_Nav: '去智能助手聊天',
  Smart_Profile_Done: '引导对话完成！智能助手已为你生成学习画像。',
  Smart_Learning_Advice_Section: '智能学习建议',
  Feature_Lesson: '教案',
  Feature_Lesson_Desc: '系统化教案与智能辅导，帮助你循序渐进掌握每个知识点',
  Profile_Onboarding: '画像',
  Home_CTA_Title: '准备好开始了吗？',
  Home_CTA_Subtitle: '加入数名开发者，一起提升算法能力',
  Home_CTA_Button: '开始刷题',
  Home_CTA_Button_Outline: '学习路径',
  Stat_Selected_Problems: '精选题目',
  Stat_Active_Users: '活跃用户',
  Stat_Total_Submissions: '总提交数',
  Stat_System_Stability: '系统稳定性',
  // Fullscreen
  Fullscreen: '全屏',
  // CodeEditorFullscreen.vue
  Run_Success: '运行成功',
  CPU_Timeout: 'CPU超时',
  Realtime_Timeout: '实时超时',
  ...
  Copy_Failed: '复制失败',
  Code_Cannot_Be_Empty: '代码不能为空',
  Code_Submit_Success: '代码提交成功',
  Submit_Failed: '提交失败',
  // AIChatFullscreen.vue
  How_Learn_DP: '如何学习动态规划？',
  Explain_Time_Complexity: '解释一下时间复杂度',
  Binary_Tree_Traversal: '二叉树遍历有哪些方法？',
  How_Debug_Code: '如何调试代码？',
  AI_Thinking_Text: '正在思考...',
  No_Reply: '无回复',
