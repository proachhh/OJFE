export const m = {
  ...
  Generate_Path: '生成路徑',
  Your_Weakest_Topic: '你的薄弱知識點',
  Suggested_Problem: '推薦題目',
  No_Problem_Yet: '暫無推薦題目',
  Select_Topic_To_Generate_Path: '選擇目標知識點以生成學習路徑',
  Path_Not_Found: '未找到學習路徑，請嘗試其他目標知識點',
  Fetch_Topics_Failed: '獲取知識點列表失敗',
  Please_Select_Target_Topic: '請選擇目標知識點',
  Network_Error: '網絡錯誤，請稍後重試',
  Start_Topic: '起點知識點',
  Select_Start_Topic: '請選擇起點（留空為薄弱點）',
  Lesson_Plans: '教案學習',
  ...
  Spark_AI_Description: '我可以幫你解答編程問題、算法思路、代碼調試等各種技術問題',
  Me: '我',
  AI_Thinking: 'AI 正在思考...',
  Enter_Your_Question_Start: '輸入你的問題開始對話...',
  Enter_Your_Question: '輸入你的問題...',
  Send: '發送',
  Run_Code: '運行代碼',
  Clear: '清空',
  Run_Result: '運行結果',
  Write_Code_Here: '// 在這裡編寫代碼\n',
  // AIChatFullscreen.vue
  Clear_Chat: '清空對話',
  // CodeEditorFullscreen.vue
  Free_Code_Editor_Desc: '自由代碼編輯器 - 無需綁定題目，直接運行代碼',
  Copy: '複製',
  Run_Time: '運行時間',
  Memory_Usage: '內存使用',
  Program_Output: '程序輸出',
  ...
  Memory: '內存',
  // LearningReport.vue
  No_Knowledge_Data: '暫無知識點數據',
  Weakness_Advice_No_Submission: '知識點您已提交 {total} 次，但尚未通過任何一題，建議加強練習。',
  // LearningPath.vue
  Learning_Path_Subtitle: '選擇起點和目標，生成你的專屬學習路徑',
  Search_Topics: '查找知識點',
  // Home.vue
  Home_Hero_Title: '探索 · 知識星海',
  Home_Hero_Subtitle: 'From Zero to Hero，構建你的專屬學習路徑',
  Home_Announcements: '最新公告',
  Home_Features_Title: '為什麼選擇我們',
  Home_Features_Subtitle: '專業、高效、智能的算法學習平台',
  Feature_Knowledge_Graph: '智能知識圖譜',
  Feature_Knowledge_Graph_Desc: '可視化展示知識點關聯，幫助你系統性地學習和理解算法體系',
  Feature_Recommendation: '個性化推薦',
  Feature_Recommendation_Desc: '基於你的學習數據，智能推薦適合你的題目，高效提升',
  Feature_Evaluation: '實時評測系統',
  Feature_Evaluation_Desc: '支持多種編程語言，秒級評測結果，詳細的錯誤反饋幫助你快速定位問題',
  Feature_AI_Gen: 'AI生成題目',
  Feature_AI_Gen_Desc: 'AI智能生成個性化練習題，針對薄弱知識點精準強化',
  Feature_AI_Agent: '多智能體 AI 助手',
  Feature_AI_Agent_Desc: '6大智能體協同工作：畫像分析、資源生成、學習路徑規劃、題目推薦、解題提示、錯誤診斷',
  Smart_Personalized_Advice: '智能個性化學習建議',
  Smart_Gen_Advice: '智能生成學習建議',
  Smart_Topic_Summary: '智能知識點總結',
  Smart_Gen_Summary: '智能生成總結',
  Smart_Profile_Invite: '讓智能助手深入了解你的學習情況，為你量身定製學習路徑和題目推薦。',
  Smart_Profile_CTA: '智能助手將為你生成專屬學習畫像',
  Smart_Profile_Onboarding_Desc: '為了更好地為你推薦學習路徑和題目，請先回答幾個簡單的問題，幫助智能助手了解你的學習情況。',
  Smart_Chat_Nav: '去智能助手聊天',
  Smart_Profile_Done: '引導對話完成！智能助手已為你生成學習畫像。',
  Smart_Learning_Advice_Section: '智能學習建議',
  Feature_Lesson: '教案輔導',
  Feature_Lesson_Desc: '系統化教案與智能輔導，幫助你循序漸進掌握每個知識點',
  Profile_Onboarding: '學習畫像',
  Home_CTA_Title: '準備好開始了嗎？',
  Home_CTA_Subtitle: '加入數名開發者，一起提升算法能力',
  Home_CTA_Button: '開始刷題',
  Home_CTA_Button_Outline: '學習路徑',
  Stat_Selected_Problems: '精選題目',
  Stat_Active_Users: '活躍用戶',
  Stat_Total_Submissions: '總提交數',
  Stat_System_Stability: '系統穩定性',
  // Fullscreen
  Fullscreen: '全屏',
  // CodeEditorFullscreen.vue
  Run_Success: '運行成功',
  CPU_Timeout: 'CPU超時',
  Realtime_Timeout: '實時超時',
  Memory_Exceeded: '內存超限',
  Runtime_Error: '運行錯誤',
  Waiting: '等待中',
  Judging: '判題中',
  Unknown_Status: '未知狀態',
  Code_Copied: '代碼已複製到剪貼板',
  Copy_Failed: '複製失敗',
  Code_Cannot_Be_Empty: '代碼不能為空',
  Code_Submit_Success: '代碼提交成功',
  Submit_Failed: '提交失敗',
  // AIChatFullscreen.vue
  How_Learn_DP: '如何學習動態規劃？',
  Explain_Time_Complexity: '解釋一下時間複雜度',
  Binary_Tree_Traversal: '二叉樹遍歷有哪些方法？',
  How_Debug_Code: '如何調試代碼？',
  AI_Thinking_Text: 'AI正在思考...',
  No_Reply: '無回覆',
  Request_Failed: '請求失敗，請稍後重試',
  Network_Error_Text: '網絡錯誤，請檢查網絡連接',
  // GlobalSidebar.vue
  Run_Failed: '運行失敗',
  No_Output: '無輸出',
  // Top-level tag keys
